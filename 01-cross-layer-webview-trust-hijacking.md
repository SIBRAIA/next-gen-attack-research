...
> **Audit note:** The claim-to-evidence mapping and evidence classifications are provided in **Appendix A — Evidence & Claim Matrix** and **Appendix B — Evidence Boundaries**. Sample-specific identifiers and source locations are retained privately.
...
However, this paper does **not** attribute any specific reverse-engineering-group compromise to an original RAT developer without independent forensic evidence.
...
> “This is the strongest permission-stealing method in the world.”

cannot be scientifically established because there is no universal benchmark ranking all Android attack techniques by one measure of strength.
...
# 19. Recommended Responsible-Disclosure Statement
...
>
> The issue is therefore best classified as a **Web-to-Native trust-boundary failure / Cross-Layer WebView Trust Hijacking**, not as demonstrated server-side compromise.
>
...
7. **The cross-layer WebView-to-Native pattern can support high-impact permission-acquisition and device-takeover workflows in modern Android financial malware. “Trust Conversion” is the analytical model used in this paper to explain that progression; the reviewed evidence does not support calling any single technique universally “the strongest in the world.”**
...
Do **not** characterize the finding as proving any of the following:
...
✗ A unique “first-ever” invention date for the exact technique
✗ Proof that one hidden developer/controller designed the full 2010–2026 evolution
✗ A universally measurable “strongest attack in the world”
...
✗ Attribution of a specific cracking/reverse-engineering-group compromise to a RAT developer
```

## B.4 Claims requiring additional validation

The following would require new evidence before publication as facts:
...
| Who compromised a particular cracking/reverse-engineering group? | Verifiable forensic artifacts, authenticated leak provenance, infrastructure evidence, or credible attribution reporting. |

## B.5 Recommended wording discipline

Use:

> **The sample demonstrates a Web-to-Native trust path capable of local page instrumentation, data transfer into native code, and initiation of sensitive native workflows.**

Use:

> **Public threat intelligence documents close operational analogues in Android financial malware.**

Use:

> **A legitimate website can remain uncompromised at the server while its interaction is manipulated inside a hostile client environment.**

Avoid:

> “The bank website is hacked.”

Avoid:

> “Every ad can take over Android.”

Avoid:

> “The bridge automatically grants Accessibility.”

Avoid:

> “This is definitively the strongest Android attack in the world.”

Avoid:

> “SpyMax invented this exact technique.”

This wording preserves the distinction between **capability**, **reachability**, **real-world correlation**, and **attribution**.

---

# Appendix C — Reproduction and Disclosure Checklist

For an application-specific security report derived from this research, collect the following before assigning exploitability or severity:
